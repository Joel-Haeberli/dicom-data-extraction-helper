...
This file provides backward compatibility by importing from the new series-aware
version if available, otherwise falling back to the original implementation.

For new code, use SeriesCurveView from gui.viewers.curve_view directly.
"""

try:
    # Try to import the new series-aware version
    from gui.viewers.curve_view import SeriesCurveView as CurveView
    from gui.viewers.curve_view import SeriesCurveView
    HAS_NEW_CURVE_VIEW = True
except ImportError:
    # Fall back to the original implementation for backward compatibility
    HAS_NEW_CURVE_VIEW = False
    ...
    class CurveView(QWidget):
        ...
        def __init__(self, parent=None):
            ...
            self._manual_ranges_set: bool = False
...
# Re-export the CurveView class for backward compatibility
__all__ = ['CurveView']